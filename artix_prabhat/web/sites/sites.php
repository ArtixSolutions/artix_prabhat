 ...
 */
  $sites['accredify.ddev.site'] = 'accredify';
  $sites['artemis.ddev.site'] = 'artemis';
  $sites['abstain.ddev.site'] = 'abstain';
  $sites['artix.ddev.site'] = 'artix';
  $sites['indianstore.ddev.site'] = 'indianstore';
  $sites['mytesla.ddev.site'] = 'mytesla';
  
  $sites['www.accredify.me'] = 'accredify';
  $sites['www.artemis.army'] = 'artemis';
  $sites['www.abstain.guru'] = 'abstain';
